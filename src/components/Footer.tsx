          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="md:flex items-center md:items-center md:justify-between">
              ...
              <ul className="flex mb-4 justify-center md:order-1 md:ml-4 md:mb-0">
                ...
                <li className="ml-4">
                  <Link href="/" className="flex justify-center items-center text-purple-600 bg-custom-blue hover:text-gray-100 hover:bg-custom-blue2 rounded-full transition duration-150 ease-in-out" aria-label="Github">
                    <svg className="w-8 h-8 fill-white" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="ml-4">
                  <Link href="/" className="flex justify-center items-center text-purple-600 bg-custom-blue hover:text-gray-100 hover:bg-custom-blue2 rounded-full transition duration-150 ease-in-out" aria-label="Facebook">
                    <svg className="w-8 h-8 fill-white" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
