...
export const Aboutimgsection = () => {
  return (
    <div className="abg">
      <Container>
        <div className="relative flex flex-col lg:flex-row w-full h-auto p-8 lg:p-20">
          <div className="flex-1 text-left lg:pr-10 lg:pt-10 lg:pl-10">
            <h1 className="text-4xl text-white pt-10 pb-5 font-bold lg:pt-20 lg:pb-5 lg:text-6xl">
              ABOUT US
            </h1>
          ...
          <div className="lg:flex-1 flex justify-center items-center lg:justify-end">
            <Image alt="abtimg" src={imgab} className="w-full max-w-lg" />
          </div>
        </div>
      </Container>
    </div>
